...
export default function HomePage() {
  ...
  const loadData = async () => {
    try {
      const [featured, allProducts, publicStats] = await Promise.all([
  ...
  const reviews = [
    {
      name: 'Anna K.',
      text: 'Świetna jakość produktów! Organizery na biurko są dokładnie takie, jakich szukałam. Polecam każdemu!',
      rating: 5,
      date: '2 dni temu',
      verified: true
    },
    {
      name: 'Michał W.',
      text: 'Bardzo szybka wysyłka i profesjonalna obsługa. Produkt zgodny z opisem, jestem zadowolony z zakupu.',
      rating: 5,
      date: '1 tydzień temu',
      verified: true
    },
    ...
    {
      name: 'Tomasz B.',
      text: 'Solidna jakość wykonania, materiały wysokiej klasy. Widać, że robione z pasją do detali.',
      rating: 5,
    ...
    <main className="overflow-hidden">
      ...
      <section className="py-8 border-b border-border bg-card/50">
        <div className="section-container">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-wrap items-center justify-center gap-8 md:gap-16 text-sm"
          >
            {[
        ...
        <div className="section-container">
          ...
          >
            {[
              ...
              { 
                icon: Users, 
                value: stats?.happyCustomers || 150, 
            ...
            {[
              {
                ...
                description: 'Każdy produkt jest starannie zaprojektowany i wydrukowany z najwyższą precyzją.'
              },
              {
                icon: Leaf,
                title: 'Ekologiczne materiały',
                description: 'Używamy biodegradowalnych filamentów PLA i PETG przyjaznych dla środowiska.'
              },
              {
                icon: Zap,
                title: 'Szybka realizacja',
                description: 'Wysyłka w ciągu 24h od złożenia zamówienia na terenie całej Polski.'
              }
            ].map((feature, idx) => (
      ...
      <section className="py-24 bg-card/30 relative overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-4">Ponad 150+ zadowolonych klientów</p>
          </motion.div>
          ...
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-primary/20 via-primary/10 to-transparent rounded-3xl p-8 text-center"
              >
      ...
      <section className="py-24">
        <div className="section-container">
          <motion.div 
            {...fadeInUp}
            className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border border-primary/20 rounded-3xl p-12 md:p-16 text-center relative overflow-hidden"
          >
